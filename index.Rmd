...
* Mathematically acceptable and embodies the logic of its creation `r emo::ji("thumbs_up")`

--

* Conforms with established intuition `r emo::ji("thumbs_up")`

--

* **`Measure pure ITD`** `r emo::ji("grimace")` `r emo::ji("question")`
...
img1 <- readPNG("pics/Scenarios_Setup2.PNG")
grid.raster(img1)
```
